...
export default function Home() {
  return (
    <main>
      ...
      <div id="about" className="my-24 w-full min-h-screen py-8 px-4 md:px-20 justify-center items-center grid grid-cols-1 md:grid-cols-2 bg-gradient-to-b from-slate-900 to-slate-800">
      ...
      <div id="product" className="my-24 w-full min-h-screen bg-gradient-to-br from-slate-800 via-slate-600 to-slate-900">
        <div className="bg-[url(/topography.svg)] bg-center">
          <div className="w-full h-screen flex justify-center items-center bg-gradient-to-b from-slate-800 to-transparent">

            <a href="#" className="relative w-full grid grid-cols-1 md:grid-cols-2 mx-4 md:mx-24 rounded-lg shadow-sm bg-gradient-to-r from-pink-600 via-pink-600 to-pink-900">
