...
export default function Home() {
  return (
    <main>
      ...
      <div className="w-full min-h-screen bg-[url(/maxresdefault.jpg)] bg-center bg-cover">
        <div className="w-full h-screen flex flex-col justify-center items-center text-center bg-gradient-to-b from-slate-600/30 to-slate-900">
          ...
          <a href="#product" className="mb-4 group px-6 py-2 rounded-md bg-gradient-to-tl from-pink-600 to-pink-700 text-gray-300 hover:text-white hover:shadow-md shadow-secondary duration-200">
            See Our Menu
          ...
          <a href="https://gofood.link/a/CHmtFS1" className="group px-6 py-2 rounded-md bg-gradient-to-tl from-green-700 to-green-500 text-gray-300 hover:text-white hover:shadow-md shadow-secondary duration-200">
            Order Now
            <FaShoppingCart size={18} className="inline-block ml-2 -translate-x-1 group-hover:translate-x-1 duration-200" />
          </a>
        </div>
      </div>
      ...
      <div id="about" className="py-24 w-full min-h-screen px-4 md:px-20 justify-center items-center grid grid-cols-1 md:grid-cols-2 bg-gradient-to-b from-slate-900 to-slate-800">
        ...
        <div className="text-center md:text-left">
          <h2 className="text-xl font-bold text-pink-600">About</h2>
          ...
          <a href="#product" className="group px-6 py-2 rounded-md bg-gradient-to-tl from-pink-600 to-pink-700 text-gray-300 hover:text-white hover:shadow-md shadow-secondary duration-200">
            See Our Menu
      ...
      <div id="product" className="w-full min-h-screen bg-gradient-to-br from-slate-800 via-slate-600 to-slate-900">
        <div className="bg-[url(/topography.svg)] bg-center">
          <div className="py-24 w-full min-h-screen flex justify-center items-center bg-gradient-to-b from-slate-800 to-transparent">
      ...
      <div id="contact" className="w-full grid grid-cols-1 md:grid-cols-2 bg-gradient-to-tr from-slate-800 via-slate-600 to-slate-900">
        ...
        <div className="w-full h-[300px] flex flex-col justify-center bg-slate-900 p-4">

          <h1 className="text-3xl font-light text-pink-600 mb-4">Supbuah Soeltan</h1>

          <div className="mb-4 flex items-center gap-2">
            <span className="bg-pink-600 text-white rounded-full p-2">
              <IoLocationOutline size={20} />
            </span>
            <div>
              <h2 className="text-xl font-bold text-pink-600">Location :</h2>
              <p className="text-gray-300 text-sm">Jl. Beton IV No. 3, Ponganganrejo, Yosowilangun, Kec. Manyar</p>
            </div>
          </div>
          ...
          <div className="mb-4 flex items-center gap-2">
            ...
            <div>
              <h2 className="text-xl font-bold text-pink-600">Call :</h2>
              <p className="text-gray-300 text-sm">+62 85608929378</p>
            </div>
          </div>
          ...
          <div className="mb-4 flex items-center gap-2">
            ...
            <div>
              <h2 className="text-xl font-bold text-pink-600">Email :</h2>
              <p className="text-gray-300 text-sm">supbuahsoeltan@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
